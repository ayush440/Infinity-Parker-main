<template>
  <label :for="id" class="form-button inline-flex items-center max-w-20 z-0" :class="{
    ...
    <div
      ...
      :class="{
        'bg-[#8b7eff]': modelValue,
        'bg-white dark:border-white': !modelValue
      }"
    >
      <div
        class="absolute mt-[-0.5px] h-[1.15rem] w-[1.15rem] border-2 border-gray-200 dark:border-gray-300 rounded-full  transform duration-300 ease-in-out bg-white"
        :class="{
