<template>
        ...
        <div v-if="invoiceData" ref="contentToConvert" id="invoice-modal" class="intro-y box overflow-auto">
          <div class="flex flex-col items-center lg:flex-row pt-10 px-5  lg:pb-10 text-center sm:text-left"  >
            ...
            <div class="mt-10 lg:mt-0 lg:ml-auto lg:text-right">
              <a v-if="invoiceConfigration" class="flex justify-center items-center h-12 px-1 logo-lg rounded-md w-fit cursor-pointer" href="/" alt ="logo">
                <logoComp />
              </a>
  ...
  <!-- for download use -->
  <div v-if="invoiceData" ref="contentToConvert" id="invoice-modal2" class="hidden bg-third-light text-tableText min-w-[550px] max-w-[580px] box">
