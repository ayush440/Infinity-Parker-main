...
<!-- quote of the day -->
<template>
    <div class="intro-y dark:text-white border shadow  box col-span-12 lg:col-span-6  ml-2 mr-2 sm:ml-4 sm:mr-4  ">
        <!-- heading -->
        <div
...
.intro-y {
        @apply border rounded bg-white dark:bg-primary dark:border-none;
    }
</style>